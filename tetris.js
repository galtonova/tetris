...
const randomShape = () => {
  ...
  switch(randomElem(shapes)) {
    case 'T': return new ShapeT(game.config.tetrisBoardWidth);
    case 'I': return new ShapeI(game.config.tetrisBoardWidth);
  }
};
...
const init = () => {
  ...
  game.config.tetrisBoardWidth = 15; // how many tetris boxes horizontally
